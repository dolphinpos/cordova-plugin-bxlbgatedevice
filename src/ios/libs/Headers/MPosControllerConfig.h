...
- (MPOS_RESULT) getSerialConfig: (NSInteger)deviceId serialConfigBlock:(void(^)(NSArray<NSNumber*>*)) serialConfigBlock;
- (MPOS_RESULT) setSerialConfig: (NSInteger)deviceId baudRate:(NSInteger) baudRate dataBit:(NSInteger) dataBit
                            stopBit:(NSInteger) stopBit parityBit:(NSInteger) parityBit;

- (MPOS_RESULT) getSerialConfiguration: (NSInteger)deviceId serialConfigBlock:(void(^)(NSArray<NSNumber*>*)) serialConfigBlock;
- (MPOS_RESULT) setSerialConfiguration:(NSInteger)deviceId baudRate:(NSInteger) baudRate dataBit:(NSInteger) dataBit stopBit:(NSInteger) stopBit
                      parityBit:(NSInteger) parityBit flowControl:(NSInteger) flowControl;
